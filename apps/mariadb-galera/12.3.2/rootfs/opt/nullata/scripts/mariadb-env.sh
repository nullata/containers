...
# 1. Custom environment variables defined below after Nullata defaults
# 2. Constants defined in this file (environment variables with no default), i.e. NULLATA_ROOT_DIR
...
export NULLATA_ROOT_DIR="/opt/nullata"
export NULLATA_VOLUME_DIR="/nullata"
...
# Paths
export DB_BASE_DIR="${NULLATA_ROOT_DIR}/mariadb"
export DB_VOLUME_DIR="${NULLATA_VOLUME_DIR}/mariadb"
...
export DB_PLUGIN_DIR="${DB_BASE_DIR}/lib/plugin"
export DB_CONF_FILE="${DB_CONF_DIR}/my.cnf"
export DB_PID_FILE="${DB_TMP_DIR}/mariadbd.pid"
export DB_SOCKET_FILE="${DB_TMP_DIR}/mysql.sock"
export PATH="${DB_SBIN_DIR}:${DB_BIN_DIR}:/opt/nullata/common/bin:${PATH}"
...
export MARIADB_GALERA_CONF_DIR="${MARIADB_GALERA_CONF_DIR:-/opt/nullata/mariadb/conf}"
export DB_GALERA_CONF_DIR="$MARIADB_GALERA_CONF_DIR"
export MARIADB_GALERA_MOUNTED_CONF_DIR="${MARIADB_GALERA_MOUNTED_CONF_DIR:-/nullata/conf}"
